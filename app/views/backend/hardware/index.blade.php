...
@section('title0')
    ...
    @if (Input::get('status'))
        @if (Input::get('status')=='Pending')
            @lang('general.pending') @lang('general.assets')
       @elseif (Input::get('status')=='Facility')
                @lang('general.facility_inventory')
	@elseif (Input::get('status')=='Keys')
		@lang('general.keys')
	@elseif (Input::get('status')=='Lockers')
                @lang('general.lockers')
	 @elseif (Input::get('status')=='RTD')
            @lang('general.ready_to_deploy') @lang('general.assets')
        @elseif (Input::get('status')=='Undeployable')
            @lang('general.undeployable') @lang('general.assets')
        @elseif (Input::get('status')=='Deployed')
            @lang('general.deployed') @lang('general.assets')
         @elseif (Input::get('status')=='Requestable')
            @lang('admin/hardware/general.requestable') @lang('general.assets')
        @elseif (Input::get('status')=='Archived')
            @lang('general.archived') @lang('general.assets')
         @elseif (Input::get('status')=='Deleted')
            @lang('general.deleted') @lang('general.assets')
        @endif
    @else
            @lang('general.all') @lang('general.assets')
    @endif
